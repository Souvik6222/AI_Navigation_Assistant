...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/usr/sbin/git" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "/usr/sbin/git" show-ref "yaml-cpp-0.7.0"
  WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/usr/sbin/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/usr/sbin/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/usr/sbin/git" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
...
execute_process(
  COMMAND "/usr/sbin/git" status --porcelain
  WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/usr/sbin/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/usr/sbin/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/usr/sbin/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/usr/sbin/git" rebase --abort
      WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/usr/sbin/git" stash pop --index --quiet
          WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/usr/sbin/git" reset --hard --quiet
      WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
    )
    execute_process(
      COMMAND "/usr/sbin/git" stash pop --quiet
      WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/usr/sbin/git" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src"
      )
      execute_process(
        COMMAND "/usr/sbin/git" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/vista/class/class_project/AI_Navigation_Assistant/mobile/android/.cxx/Debug/3p6n645j/arm64-v8a/_deps/yaml-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
